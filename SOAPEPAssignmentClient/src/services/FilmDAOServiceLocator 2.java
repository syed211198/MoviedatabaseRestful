...
public class FilmDAOServiceLocator extends org.apache.axis.client.Service implements services.FilmDAOService {
    ...
    private java.lang.String FilmDAO_address = "http://localhost:8080/SOAPEPAssignment/services/FilmDAO";
    ...
    public services.FilmDAO getFilmDAO(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            services.FilmDAOSoapBindingStub _stub = new services.FilmDAOSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (services.FilmDAO.class.isAssignableFrom(serviceEndpointInterface)) {
                services.FilmDAOSoapBindingStub _stub = new services.FilmDAOSoapBindingStub(new java.net.URL(FilmDAO_address), this);
                _stub.setPortName(getFilmDAOWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services", "FilmDAOService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services", "FilmDAO"));
        }
